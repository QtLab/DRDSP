...
DataGenerator::DataGenerator( ModelParameterized& m ) : model(m), rk(model,*model.model.wrapFunction), tStart(0), tInterval(10), print(200), pMin(0), pMax(1), pDelta(0.1), binaryOutput(true), textOutput(false) {
