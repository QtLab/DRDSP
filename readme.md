...
3. Use the data and its secants to find a projection.
4. Use the projection and the data to reduce the data.
5. Use the reduced data and the original model to obtain the reduced model.
